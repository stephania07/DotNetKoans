...
namespace DotNetKoans.CSharp
{
    public class AboutControlStatements : Koan
    {
        ...
        public void WhyItsWiseToAlwaysUseBrackets()
        {
			...
			Assert.Equal(true, b2); // it only cares about the first line if it doesn't have curly brackets that is why it is true
        }
        ...
        public void NullableTypes()
        {
            ...
            int? nullableInt = null; //but you can do this  //this means it can be int otherwise they are null
            Assert.NotNull(true); //Eliza(i);
			Assert.Null(null); //Eliza (nullableInt);
        }
